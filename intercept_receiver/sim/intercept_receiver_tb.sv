...
module intercept_receiver_tb;
  ...
  //intercept_dwell_entry_t                         dwell_entry_mem [intercept_num_dwell_entries - 1 : 0];
  ...
  intercept_receiver #(.AXI_DATA_WIDTH(AXI_DATA_WIDTH), .ADC_WIDTH(ADC_WIDTH), .IQ_WIDTH(IQ_WIDTH)) dut
  (
    .Adc_clk        (Adc_clk),
    .Adc_clk_x4     (Adc_clk_x4),
    .Adc_rst        (Adc_rst),
  ...
  task automatic send_initial_config();
    bit [31:0] config_data [][] = '{{intercept_control_magic_num, config_seq_num++, 32'h00000000, 32'hDEADBEEF, 32'h01000000, 32'hDEADBEEF},
                                    {intercept_control_magic_num, config_seq_num++, 32'h00000000, 32'hDEADBEEF, 32'h00010101, 32'hDEADBEEF}};
