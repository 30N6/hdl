...
adi_ip_create intercept_receiver
custom_ip_files intercept_receiver [list \
  ...
  {"./hdl/intercept_dwell_controller_config_decoder.vhd"  "intercept_lib"}  \
  {"./hdl/intercept_dwell_controller.vhd"                 "intercept_lib"}  \
  {"./hdl/intercept_dwell_reporter.vhd"                   "intercept_lib"}  \
  {"./hdl/intercept_dwell_stats.vhd"                      "intercept_lib"}  \
  {"./hdl/intercept_stream_config_decoder.vhd"            "intercept_lib"}  \
  {"./hdl/intercept_stream_manager.vhd"                   "intercept_lib"}  \
  {"./hdl/intercept_stream_reporter.vhd"                  "intercept_lib"}  \
  {"./hdl/intercept_stream_encoder.vhd"                   "intercept_lib"}  \
  {"./hdl/intercept_status_reporter.vhd"                  "intercept_lib"}  \
  {"./hdl/intercept_receiver.vhd"                         "intercept_lib"}  \
]

adi_ip_properties_lite intercept_receiver
set cc [ipx::current_core]
set_property company_url {https://github.com/30N6}  $cc
set_property display_name "Intercept receiver"      $cc
set_property description  "Intercept receiver"      $cc
